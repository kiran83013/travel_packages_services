...
public interface FromCitiesRepository extends JpaRepository<FromCities, Long>{

	@Query(value = "SELECT ma.ID AS cityId, ma.City AS cityName, ma.Code AS cityCode\r\n" + 
			"FROM srm.package_config_from_cites AS pcpt\r\n" + 
	...
	Optional<FromCities> findByHeaderIdAndCityCode(Long id, String code);
