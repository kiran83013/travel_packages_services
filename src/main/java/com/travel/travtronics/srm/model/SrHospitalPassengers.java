...
@Entity
@Table(name = "sr_hospital_passengers")
@Getter
@Setter
public class SrHospitalPassengers {
	...
	@Column(name = "passenger_line_id", updatable = false)
	private Integer passengerLineId;

	@Column(name = "passenger_pax_id")
	private Integer passengerPaxId;

	@Column(name = "passenger_room_id", updatable = false)
	...
	private Integer passengerCoutry;
	...
	@Column(name = "passenger_created_device")
	private String passengerCreatedDevice;

	@Column(name = "passenger_created_ip")
