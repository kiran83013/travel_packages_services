...
@Entity
@Table(name = "sr_hospital_rooms")
@Getter
@Setter
public class SrHospitalRooms {
	...
	@Column(name = "room_line_id", updatable = false)
	...
	@Column(name = "room_created_device")
	private String roomCreatedDevice;

	@Column(name = "room_created_ip")
