...
@Entity
@Table(name = "sr_hospital_addons")
@Getter
@Setter
public class SrHospitalAddons {
	...
	public Boolean getAddonIsDeleted() {
		return addonIsDeleted;
	}

	public void setAddonIsDeleted(Boolean addonIsDeleted) {
		this.addonIsDeleted = addonIsDeleted;
	}

	public enum HsAddonFor {
		R, P
	}

	@Column(name = "addon_for")
	@Enumerated(EnumType.STRING)
	private HsAddonFor addonFor;
	...
	@Column(name = "addon_created_device")
	private String addonCreatedDevice;

	@Column(name = "addon_created_ip")
