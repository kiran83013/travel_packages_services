...
public class HotelRequestConverter {

	public static SrHotelLines convertHotelLinesJsonToModel(SrHotelLinesDto request) {

		SrHotelLines model = new SrHotelLines();
		...
		model.setLineHotelName(request.getLineHotelName());
	...
	public static SrHotelPassengers convertPassengersJsonToModel(SrHotelPassengersDto request) {

		SrHotelPassengers model = new SrHotelPassengers();
	...
	public static SrHotelRooms convertRoomsJsonToModel(SrHotelRoomsDto request) {

		SrHotelRooms model = new SrHotelRooms();
	...
	public static List<SrHotelRooms> convertListRoomJsonToModels(List<SrHotelRoomsDto> requests) {
		return requests.stream().map(HotelRequestConverter::convertRoomsJsonToModel).collect(Collectors.toList());
	}

	public static SrHotelAddons convertSrAddonsJsonToModel(SrHotelAddonsDto request) {
		SrHotelAddons model = new SrHotelAddons();
	...
	public static SrHotelLines updateHotelLinesJsonToModel(SrHotelLinesDto request, SrHotelLines model) {
		...
		if (request.getLineRoomCount() != null && request.getLineRoomCount() != 0)
			model.setLineRoomCount(request.getLineRoomCount());
		if (request.getLineHotelName() != null && !request.getLineHotelName().isEmpty())
			model.setLineHotelName(request.getLineHotelName());
	...
	public static SrHotelRooms updateRoomsJsonToModel(SrHotelRoomsDto request, SrHotelRooms model) {
		if (request.getId() != null && request.getId() != 0)
			model.setId(request.getId());
	...
	public static SrHotelPassengers updatePassengersJsonToModel(SrHotelPassengersDto request, SrHotelPassengers model) {
		if (request.getId() != null && request.getId() != 0)
			model.setId(request.getId());
