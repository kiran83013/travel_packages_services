...
public class HotelResponseConverter {

	public static SrHotelLinesDto convertHotelLinesModelToJson(SrHotelLines request) {
		SrHotelLinesDto model = new SrHotelLinesDto();
	...
	public static SrHotelPassengersDto convertPassengersModelToJson(SrHotelPassengers request) {
		SrHotelPassengersDto model = new SrHotelPassengersDto();
		model.setId(request.getId());
	...
	public static List<SrHotelPassengersDto> convertListPassgengerJsonToModels(List<SrHotelPassengers> requests) {
		return requests.stream().map(model -> convertPassengersModelToJson(model)).collect(Collectors.toList());
	}

	public static SrHotelRoomsDto convertRoomsModelToJson(SrHotelRooms request) {
		SrHotelRoomsDto model = new SrHotelRoomsDto();
		model.setId(request.getId());
	...
	public static List<SrHotelRoomsDto> convertListRoomJsonToModels(List<SrHotelRooms> requests) {
		return requests.stream().map(model -> convertRoomsModelToJson(model)).collect(Collectors.toList());
	}

	public static SrHotelAddonsDto convertSrAddonsModelToModel(SrHotelAddons request) {

		SrHotelAddonsDto model = new SrHotelAddonsDto();
		model.setId(request.getId());
	...
	public static SrHotelRoomsDto convertPostRoomsModelToJson(SrHotelRooms request,
			List<SrHotelPassengers> passengersRequest) {
		SrHotelRoomsDto model = new SrHotelRoomsDto();
		model.setId(request.getId());
		model.setRoomSrId(request.getRoomSrId());
		model.setRoomLineId(request.getRoomLineId());
...
//	public static SrHotelLinesDto convertHotelLinesModelToJsonResponse(HotelLineEntity request) {
//		SrHotelLinesDto model = new SrHotelLinesDto();
//		model.setLineUuid(request.getLineUuid());
//		model.setId(request.getId());
//		model.setLineSrId(request.getLineSrId());
